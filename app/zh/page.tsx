      ...
      <section className="py-14 md:py-28 px-4 md:px-6 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-5">
            {[
              { n: "1", t: "申请", d: "3分钟表格，告诉我们你的旅行风格。" },
              { n: "2", t: "匹配", d: "24小时内匹配同龄的韩国Mate。" },
              { n: "3", t: "聊天", d: "到达前2天开始为你定制专属行程。" },
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                q: "费用是多少？",
                a: "半天（6小时起）：$129（约¥930）（原价$222）· 全天（10小时）：$219（约¥1,580）（原价$370）· 两天：$349（约¥2,510）（原价$630）。最高可享6折上线特惠。6小时是最低保障——不是硬性结束，气氛合适自然会更长。费用含2人——加人或定制需求可以聊天沟通。无需预付。匹配成功后再付款。",
              },
              {
                q: "什么时候可以预约？",
